define([
    ...
    describe('ArticleTemplates/assets/js/modules/twitter', function () {
        ...
        describe('init()', function () {
            ...
            it('handle click on link in tweet on Android', function (done) {
                injector
                    .require(['ArticleTemplates/assets/js/modules/twitter'], function (twitter) {
                        ...
                        dummyTweet.contentWindow.document.body.innerHTML = '<a id="myLink" href="xxx"></a>';
                        ...
                        dummyTweet.contentWindow.document.getElementById('myLink').dispatchEvent(event);

                        expect(window.open).to.have.been.calledOnce;
                        expect(window.open).to.have.been.calledWith('xxx');
